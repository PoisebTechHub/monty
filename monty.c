...
int f_opcode_finder(stack_tt **stack, char *linebuff, unsigned int counter)
{
	...
	instruction_tt a[] = {
		{"push", push_element_tostack}, {"pall", function_pall},
		{"pint", pint_atheadstack}, {"pop", pop_element_stack},
		{"swap", swap_2elements_atheadstack}, {"add", add_2elements_tostack},
		{"nop", function_nop}, {"sub", sub_2elements_ofstack},
		{"div", divide_2elements_ofstack}, {"mul", multiply_2elements_ofstack},
		{"mod", function_mod},	{"#", function_nop},
		{"pchar", pchar_atheadstack}, {"pstr", pstr_atheadstack},
		{"rotl", rotl_stack_top}, {"rotr", rotr_stack_buttom},
		{"\0", NULL}
	};
